    ...
    <div style={{ background: "#1a2721"}}>
      ...
      <div className={`container mx-auto w-full mt-10`}>
        {!stakePool && stakePoolLoaded ? (
          ...
          !wallet.connected && (
            <div
              className="mx-5 mb-5 cursor-pointer rounded-md border-[1px] border-white bg-forestGreen bg-opacity-40 p-4 text-center text-lg font-semibold"
          ...
          >
            <div className="text-md font-semibold text-yellow-500">
              ...
              <a
                ...
                className="hover:text-forestGreen-50"
              >
                Solana
              </a>{' '}
        ...
        {(maxStaked || rewardDistributorData.data) && (
          <div
            className="mx-5 mb-4 flex flex-wrap items-center gap-4 rounded-md border border-white bg-forestGreen bg-opacity-40 px-10 py-6 text-gray-200 md:flex-row md:justify-between"
          >
            {stakePoolEntries.data ? (
              ...
              <div className="relative flex h-8 w-full items-center justify-center">
                ...
                <div className="absolute w-full animate-pulse items-center justify-center rounded-lg border-white bg-forestGreen bg-opacity-40 p-5"></div>
              </div>
            )}
              ...
              <>
                <div className="inline-block text-lg">
                  ...
                  <span>
                    ...
                    <a
                      className="text-white underline hover:text-forestGreen-50"
                      target="_blank"
                      href={pubKeyUrl(
        ...
        <div className="my-2 mx-5 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div
            className={`flex-col rounded-md border border-white bg-forestGreen bg-opacity-40 p-10 text-gray-200`}
          >
            ...
            <div className="my-3 flex-auto overflow-auto">
              <div className="relative my-auto mb-4 h-[60vh] overflow-y-auto overflow-x-hidden rounded-md border-white bg-forestGreen bg-opacity-40 bg-opacity-5 p-5">
                              ...
                              <div>
                                <div className="relative">
                                  {loadingStake && isUnstakedTokenSelected(tk) && (
                                    <div>
                                      <div className="absolute top-0 left-0 z-10 flex h-20 w-20 lg:h-40 lg:w-40 2xl:h-48 2xl:w-48 justify-center rounded-xl bg-black bg-opacity-80 align-middle">
            ...
            <div className="mt-2 flex items-center justify-between">
              ...
              <button
                ...
                className=" border border-white my-auto flex rounded-md px-4 py-2 hover:scale-[1.03]"
              >
          ...
          <div
            className="rounded-md border border-white bg-forestGreen bg-opacity-40 p-10 text-gray-200"
          >
            ...
            <div className="my-3 flex-auto overflow-auto ">
              <div className="relative my-auto mb-4 h-[60vh] overflow-y-auto overflow-x-hidden rounded-md border-white bg-forestGreen bg-opacity-40 p-5">
                {!stakedTokenDatas.loaded ? (
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    <div className="h-[200px] animate-pulse rounded-lg bg-white bg-opacity-5 p-10"></div>
                    <div className="h-[200px] animate-pulse rounded-lg bg-white bg-opacity-5 p-10"></div>
                                  ...
                                  <div className="relative">
                                    {(loadingUnstake || loadingClaimRewards) &&
                                      isStakedTokenSelected(tk) && (
                                        <div>
                                          <div className="absolute top-0 left-0 z-10 flex h-20 w-20 lg:h-40 lg:w-40 2xl:h-48 2xl:w-48 justify-center rounded-lg bg-black bg-opacity-80  align-middle">
            ...
            <div className="mt-2 flex flex-row-reverse">
              ...
              >
                <button
                  ...
                  className="my-auto flex rounded-md px-4 border border-white py-2 hover:scale-[1.03]"
                >
                  <span className="mr-1 inline-block ">
