      ...
      <div className="bg-white">
        ...
        >
          ...
          <div className="relative z-50 my-auto flex items-center align-middle">
            ...
            <a
              href="https://discord.com/invite/XVJ6UaqPKb"
              className="delay-50 ml-5 text-xl text-gray-700 transition duration-300 ease-in-out hover:text-gray-500"
            >
              <svg
                id="desktopLogos"
                className=""
            ...
            <a
              href="https://twitter.com/GoofyTheGoatNFT"
              className="delay-50 ml-2 text-xl text-gray-700 transition duration-300 ease-in-out hover:text-gray-500"
            >
              <svg
                id="desktopLogos"
                className=""
