    ...
    <div>
      ...
      <div className='bg-white'>
        <div className={`flex h-20 justify-between max-w-7xl mx-auto px-2 text-black`}>
          ...
          <div className="relative my-auto flex items-center align-middle z-50">
            ...
            {wallet.connected && wallet.publicKey ? (
              ...
              />
                  ...
                  <a href="https://discord.gg/stonedfarms" className="transition ease-in-out delay-50 duration-300 text-xl text-gray-700 hover:text-gray-500 ml-5">
                  ...
                  <a href="https://twitter.com/stonedfarms" className="transition ease-in-out delay-50 duration-300 text-xl text-gray-700 hover:text-gray-500 ml-2">
